    ...
    <div class="card-body" style="margin-left:50px;margin-right: 50px;margin-top:50px;">
        <form action="{{route('categories_store')}}"  method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" id="exampleFormControlInput1" placeholder="Adı">
            </div>

            <div class="form-group">
                <label for="exampleFormControlInput1">Sıra</label>
                <input type="text" name="number" class="form-control" id="exampleFormControlInput1" placeholder="Sıra">
            </div>
